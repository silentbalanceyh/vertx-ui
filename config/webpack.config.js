...
// size / loop
const devSize = process.env.Z_DEV_PLUGIN_SIZE === "true";
const devLoop = process.env.Z_DEV_PLUGIN_LOOP === "true";
const devSMP = process.env.Z_DEV_PLUGIN_SMP === "true";
...
const AntdDateWebpackPlugin = require("antd-dayjs-webpack-plugin");
...
module.exports = function (webpackEnv) {
    ...
    const webpackConfig = {
        ...
        plugins: [
            // 继续使用 moment
            new AntdDateWebpackPlugin(),
            // Development Environment Enable
            isEnvDevelopment && devSize ? new BundleAnalyzerPlugin() : false,
            isEnvDevelopment && devLoop ? new CircularDependencyPlugin({
            ...
            // isEnvDevelopment ? new BundleAnalyzerPlugin() : false,
    ...
    // Returned
    return isEnvDevelopment && devSMP ? smp.wrap(webpackConfig) : webpackConfig;
};