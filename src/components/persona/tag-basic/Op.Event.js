...
export default {
    ...
    events: {
        $opView: (reference) => (text, record) => {
            Ux.toRoute(reference, "/persona/tag-basic-create", {key: text, action: "VIEW"})
        },
        $opEdit: (reference) => (text, record) => {
            Ux.toRoute(reference, "/persona/tag-basic-create", {key: text, action: "EDIT"})
        },
        ...
        $opAdd: (reference) => (event) => {
            ...
            Ux.toRoute(reference, "/persona/tag-basic-create")
        }
    }
}