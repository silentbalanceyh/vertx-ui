...
class I {
    ...
    static attributes(identifier) {
        return _I.attributes(identifier);
    }
    ...
    static login(request = {}, options = {}) {
        return _I.login(request, options);
    }
     ...
     */
    static form(params = {}) {
        return _I.form(params); // Ux.?jaxGet(`/api/ui/form/:code`, params);
    }
    ...
    static lists(identifier) {
        return _I.lists(identifier); // Ux.?jaxGet(`/api/ui/lists/:identifier`, {identifier});
    }
     ...
     */
    static user() {
        return _I.user(); // Ux.?jaxGet(`/api/user`);
    }
    ...
    static profile(params = {}) {
        return _I.profile(params); // Ux.?jaxPost(`/api/user/profile`, params);
    }
     ...
     */
    static page(params = {}) {
        return _I.page(params); // Ux.?jaxPost('/api/ui/page', params);
    }
    ...
    static control(params = {}) {
        return _I.control(params); // Ux.?jaxPost('/api/ui/control', params);
    }
    ...
    static visitor(params = {}) {
        return _I.visitor(params); // Ux.?jaxPost('/api/ui/visitor/:identifier/:page', params);
    }
     ...
     */
    static ops(params = {}) {
        return _I.ops(params); // Ux.?jaxPost('/api/ui/ops', params);
    }
    ...
    static todo(params = {}, confirmed = true) {
        return _I.todo(params, confirmed);
    }
     ...
     */
    static jobStart(key) {
        return _I.jobStart(key); // Ux.?jaxPut("/api/job/start/:key", {key});
    }
     ...
     */
    static jobStop(key) {
        return _I.jobStop(key); // Ux.?jaxPut("/api/job/stop/:key", {key});
    }
    ...
    static jobResume(key) {
        return _I.jobResume(key); // Ux.?jaxPut("/api/job/resume/:key", {key});
    }
     ...
     */
    static relation() {
        return _I.relation(); // Ux.?jaxGet("/api/relation", {});
    }
    ...
    static relationSave(relations = []) {
        return _I.relationSave(relations);
    }
