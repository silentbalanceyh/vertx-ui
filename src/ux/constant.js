...
export default {
     ...
     */
    THEME: {
        DEFAULT_8: ["#48aaf7", "#d00036", "#44bc78", "#030f1f", "#e79627", "#7d4ab8", "#70d5fe", "#7077eb"],
        WEEK_8: ["#263B77", "#5988FF", "#00BF9F", "#00DAD8", "#FF5765", "#F9D22D", "#FF8744", "#00DC26"],
        ...
        // BUS 四种：背景色、浅色、中度、深色
        BG_BUS_6: ["#FBEED0", "#FED8F2", "#EECDF4", "#D1CCF2", "#D4F0F7", "#DBF2F3"],
