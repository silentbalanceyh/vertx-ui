...
export default {
    ...
    ORIGIN: Aid.jsxConnect(
        ...
        (attrs = {}) => {
            ...
            return Field.aiInputSelect(items, rest);
        }
    ),
    // ---- DATUM
    ...
    DECIMAL: Aid.jsxConnect(
        (reference, params = {}, channel = {}) => {
            ...
            channel.fnChange = Aid.onChangeUnit(attrs, reference, {
                ...params, normalize: Raft.Normalizer.decimal(18, 2)
            });
            return attrs;
        },
        null,
    ...
    RADIO: Aid.jsxConnect(
        ...
        (attrs) => {
            const {items = [], ...rest} = attrs;
            return Field.aiInputRadio(items, rest);
        }
    ),
    // ---- INDEX_RADIO
    ...
    TEXT_AREA: Aid.jsxConnect(
        ...
        (attrs = {}) => {
            ...
            return Unit.aiCell(Input.TextArea, rest, value);
        }
    ),
